...
public abstract class AbstractQuartzJob implements Job
{
    ...
    protected void after(JobExecutionContext context, SysJob sysJob, Exception e)
    {
        ...
        long runMs = LocalDateTimeUtils.diffMillis(sysJobLog.getStopTime(), sysJobLog.getStartTime());
        ...
        // 写入数据库当中
        SpringUtils.getBean(ISysJobLogService.class).insert(sysJobLog).subscribe();
    }
