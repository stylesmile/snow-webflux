...
public class SysUserService {
    ...
    public Result<String> getSysUserByNameAndPassword(String username, String password, HttpSession session) {
        SysUser user = sysUserRepository.getSysUserByNameAndPassword(username);
...
//        return sysUserRepository.getUserList(sysUserQuery);
    ...
    public Boolean updateUser(SysUser user) {
        Boolean bool = sysUserRepository.updateUser(user);
    ...
    public Boolean deleteUser(Integer id) {
        Boolean bool = sysUserRepository.deleteUser(id);
        this.clearUserListCache();
    ...
    public Object saveOrUpdate(SysUser user) {
        return null;
    }

    public Mono<SysUser> getById(String id) {
        return sysUserRepository.findById(Integer.valueOf(id));
    }
}
